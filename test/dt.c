...
static struct
{
	...
	// Bug - 16 digits returned, not 17, and it's the second to last missing (3457 instead of 34567)
	...
	{"1.23456589e-307", DEFAULT_DTOA_MODE, DEFAULT_DTOA_NUM_DIGITS, 1.23456589e-307, 0, -306, 9, "123456589", 0},
	// Bug - 16 digits returned, not 17, and it's the second to last missing (3457 instead of 34567)
	//{"1.234567890123456789", DEFAULT_DTOA_MODE, DEFAULT_DTOA_NUM_DIGITS, 1.234567890123456789, 0, 1, 17, "12345678901234567", 0},
	// Bug - 16 digits returned, not 17, returns 1234567890123457 instead of 12345678901234568
	//{"1.234567890123456789e301", DEFAULT_DTOA_MODE, DEFAULT_DTOA_NUM_DIGITS, 1.234567890123456789e301, 0, 302, 17, "12345678901234568", 0},
	// Bug - strings don't match, num digits do: 12345678901234567, expected 12345678901234568
	...
	// Bug for both - num digits 16 (should be 17), value: 2225073858507202, expected: 22250738585072014
